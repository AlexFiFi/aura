...
public class Eremon_belfast_02Script : NPCScript
{
	public override void OnLoad()
	{
		SetName("_eremon_belfast_02");
		SetRace(10001);
		...
		EquipItem(Pocket.Face, 0xF53, 0xFDBDAB, 0x6661, 0xB2ADD5);
		...
		SetLocation(region: 4005, x: 22774, y: 29325);
